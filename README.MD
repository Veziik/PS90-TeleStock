...
# Printing Instructions
 ...
 - For the Metal Arm Version, skip to the machining instructions

1. Go into the STL - STEP - PDF Files\Telescoping - Plastic Arms folder.
...
4. Pick one of the three folders: I-Beam Arms, Low Profile Arms, or Standard Arms. Print the following files on your printer of choice at 100% infill, orient them so that their flatest side is touching the build plate.
    - LeftTelescopingBar.stl
    - RightTelescopingBar.stl

# Steel Arms: Machining+Printing Instructions
- Material-wise, youll want a bar or sheet of 3/16" thick metal, it can be whatever you want, but I use mild steel.
- You'll need one of the following to cut the locking pin and the two steel arms: A waterjet cutter, a laser cutter, a cnc mill, or a regular mill. Ideally you'll want to use a waterjet and/or a service that provides cutting of sheet metak to bypass this step.
- The steel arms need to have a countersink drilled into them on opposing sides, use the included STL file to locate and properly drill out the countersink for an M4x8mm countersunk screw. This can be done with a hand drill and some patience.
- The locking pin can optionally have one of the long edges bevelled to make telescoping easier on the ears and hands.
- As for printing: 
    - follow the same instructions as above, but do not print LockingPin.stl, PadCrosspin.stl, LeftTelescopingBar.stl, or RightTelescopingBar.stl.
    - Additionally print Endcap.stl TWICE.
    - Make sure to drill out the pin hole in TelescopingPad.stl with a 4mm drill bit to make sure inserting the roll pin isn't the hardest thing you'll do all day .


# Assembly Instructions
## Required Parts - Plastic Version:
- A 3mm spring of at least 15mm in length. Degree of stiffness is up to you.
- The parts printed in the Printing Instructions section.
## Additional Parts - Steel Version Only:
...
# IF YOU ARE BUILDING THIS AT HOME FOR YOUR OWN PS90, FOLLOW EITHER SET OF INSTRUCTIONS EXACTLY TO REMAIN COMPLIANT WITHIN YOUR STATE THROUGHOUT THE BUILD PROCESS
## Step order - Plastic Version:
...
7. Push the button up all the way into the telescoping body and insert both of the telescoping arms in from the dovetail side of the telescoping body. This is where we check to make sure that both of the arms glide comfortably, but snug to the telescoping body, in addition to locking and unlocking without the application anything mroe than a gentle push. Both arms should have their cutouts facing up, and the holes for the crosspin with the pad should away from the dovetail side.
...
11. Screw the endcaps on the end of each rail.
12. Okay, NOW you can disassemble your PS90, all the way to the point where you remove your butttstock. If you dont know how to disassebmle your PS90, read the manual for your PS90 to learn its disassembly.
13. Extend the telescoping pad all the way from the telecoping body. Slide the dovetail of the telescoping body into the place where the old buttpad was. There may need to be some sanding done to get a proper fit, but that way the butt isnt sloppy or too weak to handle mismanagement.
...
### When Repairing, ALWAYS keep at least one telesoping arm inserted into the main telescoping body or completely disassemble the firearm before repairing, regardless of damage taken. NEVER leave the main telescoping body without telescoping bars. When replacing both bars, simply swap the bars out one at a time, and always keep the pad connected to the telescoping bars whenever possible. 
